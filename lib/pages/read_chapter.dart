...
class ReadChapterPage extends StatefulWidget {
  ...
  ReadChapterPage(this.books, this.chapter, this.idxBook);

  @override
  _ReadChapterPageState createState() =>
      _ReadChapterPageState(books, chapter, idxBook);
}
...
class _ReadChapterPageState extends State<ReadChapterPage> {
  ...
  _ReadChapterPageState(this.books, this.chapter, this.idxBook);
